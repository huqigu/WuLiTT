...
fileprivate final class GroupedObservableImpl<Key, Element>: Observable<Element> {
...
fileprivate final class GroupBySink<Key: Hashable, Element, O: ObserverType>
    : Sink<O>
...
fileprivate final class GroupBy<Key: Hashable, Element>: Producer<GroupedObservable<Key, Element>> {
