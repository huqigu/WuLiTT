...
fileprivate final class ReduceSink<SourceType, AccumulateType, O: ObserverType>: Sink<O>, ObserverType {
...
fileprivate final class Reduce<SourceType, AccumulateType, ResultType>: Producer<ResultType> {
