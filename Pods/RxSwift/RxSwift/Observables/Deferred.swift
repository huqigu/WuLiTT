...
fileprivate final class DeferredSink<S: ObservableType, O: ObserverType>: Sink<O>, ObserverType where S.E == O.E {
    typealias E = O.E
...
fileprivate final class Deferred<S: ObservableType>: Producer<S.E> {
