...
extension JCTabBarController {
    ...
    func addChildViewControllers() -> Void {
        ...
        self.addChildViewController(createChildViewController(vc: vc1, title: "首页", imageName: "ic_tab_home_29x29_", selectedImageName: "ic_tab_chosenhome_29x29_"))
        self.addChildViewController(createChildViewController(vc: vc2, title: "喵圈", imageName: "ic_tab_play_29x29_", selectedImageName: "ic_tab_chosenplay_29x29_"))
        self.addChildViewController(createChildViewController(vc: vc3, title: "任务", imageName: "ic_tab_message_29x29_", selectedImageName: "ic_tab_chosenMessage_29x29_"))
        self.addChildViewController(createChildViewController(vc: vc4, title: "我的", imageName: "ic_tab_mine_29x29_", selectedImageName: "ic_tab_chosenmine_29x29_"))
    ...
    func createChildViewController(vc : JCViewController , title : String ,imageName : String , selectedImageName : String) -> JCNavigationController {
        ...
        return JCNavigationController.init(rootViewController: vc)
    }
